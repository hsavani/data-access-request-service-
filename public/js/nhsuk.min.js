...
!function (n) {
    ...
    window, o = function o() {
      return r = {}, o.m = n = [function (e, t, n) {
        function h(e, t, n) {
          ...
          for (r in l && (n = t), n) {
            i = ((o = !a && p && void 0 !== p[r]) ? p : n)[r], u = c && o ? g(i, v) : s && "function" == typeof i ? g(Function.call, i) : i, p && b(p, r, i, e & h.U), f[r] != i && y(f, r, u), s && d[r] != i && (d[r] = i);
          }
        }
        ...
        function a(e) {
          !e._dirty && (e._dirty = !0) && 1 == u.push(e) && (C.debounceRendering || o)(f);
        }
        ...
        function D(e, t, n, r, o) {
          ...
          if ("function" == typeof s) return function (e, t, n, r) {
            ...
            return o && l && (!r || o._component) ? (T(o, s, 3, n, r), e = o.base) : (i && !a && (R(i), e = u = null), o = q(t.nodeName, s, n), e && !o.nextBase && (o.nextBase = e, u = null), T(o, s, 1, n, r), e = o.base, u && e !== u && (u._component = null, B(u, !1))), e;
          }(e, t, n, r);

          if (N = "svg" === s || "foreignObject" !== s && N, s = String(s), (!e || !E(e, s)) && (a = s, (l = N ? document.createElementNS("http://www.w3.org/2000/svg", a) : document.createElement(a)).normalizedNodeName = a, i = l, e)) {
            for (; e.firstChild;) {
          ...
          return !I && f && 1 === f.length && "string" == typeof f[0] && null != c && void 0 !== c.splitText && null == c.nextSibling ? c.nodeValue != f[0] && (c.nodeValue = f[0]) : (f && f.length || null != c) && function (e, t, n, r, o) {
            var i,
                u,
                a,
                l,
            ...
            if (0 !== _) for (w = 0; w < _; w++) {
              ...
              if ((s = null) != (S = (l = t[w]).key)) m && void 0 !== v[S] && (s = v[S], v[S] = void 0, m--);else if (y < g) for (i = y; i < g; i++) {
                if (void 0 !== h[i] && (c = u = h[i], f = o, "string" == typeof (p = l) || "number" == typeof p ? void 0 !== c.splitText : "string" == typeof p.nodeName ? !c._componentConstructor && E(c, p.nodeName) : f || c._componentConstructor === p.nodeName)) {
                  s = u, h[i] = void 0, i === g - 1 && g--, i === y && y++;
                  break;
                }
              }
              s = D(s, l, n, r), a = d[w], s && s !== e && s !== a && (null == a ? e.appendChild(s) : s === a.nextSibling ? j(a) : e.insertBefore(s, a));
            }
            if (m) for (var w in v) {
              void 0 !== v[w] && B(v[w], !1);
            }
          ...
          }(i, f, n, r, I || null != p.dangerouslySetInnerHTML), function (e, t, n) {
            var r;

            for (r in n) {
              t && null != t[r] || null == n[r] || v(e, r, n[r], n[r] = void 0, N);
            }

            for (r in t) {
              "children" === r || "innerHTML" === r || r in n && t[r] === ("value" === r || "checked" === r ? e[r] : n[r]) || v(e, r, n[r], n[r] = t[r], N);
            }
        ...
        function B(e, t) {
          var n = e._component;
          n ? R(n) : (null != e.__preactattr_ && e.__preactattr_.ref && e.__preactattr_.ref(null), !1 !== t && null != e.__preactattr_ || j(e), h(e));
        }
          ...
          if (!e._disable) {
            ...
            if (e.constructor.getDerivedStateFromProps && (l = k(k({}, l), e.constructor.getDerivedStateFromProps(a, l)), e.state = l), d && (e.props = c, e.state = p, e.context = f, 2 !== t && e.shouldComponentUpdate && !1 === e.shouldComponentUpdate(a, l, s) ? y = !0 : e.componentWillUpdate && e.componentWillUpdate(a, l, s), e.props = a, e.state = l, e.context = s), e.prevProps = e.prevState = e.prevContext = e.nextBase = null, e._dirty = !1, !y) {
              ...
              if ("function" == typeof w) {
                var x = A(o);
                (i = m) && i.constructor === w && x.key == i.__key ? T(i, x, 1, s, !1) : (g = i, e._component = i = q(w, x, s), i.nextBase = i.nextBase || h, i._parentComponent = e, T(i, x, 0, s, !1), F(i, 1, n, !0)), _ = i.base;
              } else u = v, (g = m) && (u = e._component = null), !v && 1 !== t || (u && (u._component = null), _ = function (e, t, n, r) {
                P++ || (N = null != r && void 0 !== r.ownerSVGElement, I = null != u && !("__preactattr_" in u));
                var o = D(u, e, t, n, !0);
                return r && o.parentNode !== r && r.appendChild(o), --P || (I = !1), o;
              }(o, s, n || !d, v && v.parentNode));
            ...
            for (!d || n ? M.unshift(e) : y || (e.componentDidUpdate && e.componentDidUpdate(c, p, b), C.afterUpdate && C.afterUpdate(e)); e._renderCallbacks.length;) {
        ...
        function R(e) {
          ...
          var n = e._component;
          n ? R(n) : t && (t.__preactattr_ && t.__preactattr_.ref && t.__preactattr_.ref(null), j(e.nextBase = t), m.push(e), h(t)), e.__ref && e.__ref(null);
        }
        ...
        function g(e, t, r) {
          return function (e, t) {
            P++ || (N = null != t && void 0 !== t.ownerSVGElement, I = null != r && !("__preactattr_" in r));
            var n = D(r, e, {}, !1, !1);
            return t && n.parentNode !== t && t.appendChild(n), --P || (I = !1, L()), n;
          }(e, t);
        }
        ...
        e.exports = function (p, e) {
          var f = 1 == p,
              ...
              b = e || r;
          return function (e, t, n) {
            for (var r, o, i = w(e), u = _(i), a = g(t, n, 3), l = x(u.length), s = 0, c = f ? b(e, l) : d ? b(e, 0) : void 0; s < l; s++) {
        ...
        e.exports = !o || n(4)(function () {
          ...
          for (var n = v(e), r = arguments.length, o = 1, i = d.f, u = h.f; o < r;) {
            for (var a, l = m(arguments[o++]), s = i ? f(l).concat(i(l)) : f(l), c = s.length, p = 0; p < c;) {
        ...
        var a = function (n) {
          ...
          return o.isQueryAnOption = function (e, t) {
            ...
            var e,
                ...
                M = 0 !== O.length,
                P = O.length >= o,
                N = this.props.showNoOptionsFound && A && j && M && P,
                I = n + "__wrapper",
                L = n + "__input",
                D = null !== g ? " " + L + "--focused" : "",
                ...
                F = n + "__menu",
                R = F + "--" + r,
                U = F + "--" + (w || N ? "visible" : "hidden"),
                V = n + "__option",
                W = n + "__hint",
                H = this.templateInputValue(x[S]),
            ...
            return c && "string" == typeof (e = y({
              ...
              tSelectedOption: h,
              tResults: v
            }), K && (0, G.createElement)("span", null, (0, G.createElement)("input", {
              className: W,
              readonly: !0,
              tabIndex: "-1",
              value: K
              ...
              "aria-activedescendant": !!T && u + "__option--" + g,
  ...
  n(2), document.addEventListener("DOMContentLoaded", function () {
    var t, e, n, r, o;
    m(), v(), t = document.querySelector("h1"), e = document.querySelector(".nhsuk-skip-link"), t && e && (e.addEventListener("click", function (e) {
      ...
      e.addEventListener("change", function (e) {
        n.forEach(function (e) {
          ...
          return u(e, "nhsuk-radios__conditional--hidden");
        }), a(e.target, "nhsuk-radios__conditional--hidden");
      });
      ...
      e.addEventListener("change", function (e) {
        a(e.target, "nhsuk-checkboxes__conditional--hidden");
      });
    });
  });
}]);